...
## Your task
The NMCP has a budget of **USD 250,000**. There are four regions in Tanzania (North, South, East and West) each with 25 health facilities. From previous studies conducted by the NMCP, we know that the intra-cluster correlation is **0.01**. We have conducted  Your job is to design a study powered for the following end-points: 
...
- [`r fa("calculator")` **Statistician**](statistician_sheet_tz.Rmd) (1-2 people): Handle sample size calculations and adjust for ICC.