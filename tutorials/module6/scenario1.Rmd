...
## Your task
The NMCP has a budget of **USD 500,000**. There are four regions in Tanzania (North, South, East and West) each with 25 health facilities. From previous studies conducted by the NMCP, we know that the intra-cluster correlation is **0.1**. We have conducted  Your job is to design a study powered for the following end-points: 
