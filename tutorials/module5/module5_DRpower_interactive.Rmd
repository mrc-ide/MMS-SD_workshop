...
Download a .csv file with the current study plan [from here](https://raw.githubusercontent.com/mrc-ide/MMS-SD_workshop/refs/heads/main/tutorials/module5/data/pfhrp2_design.csv). You can then upload this spreadsheet into the we app using the "Upload a .csv file" option. You should find that the table populates with these values.
...
You can download these results in .csv form [here](https://github.com/mrc-ide/MMS-SD_workshop/blob/main/tutorials/module5/data/pfhrp2_results.csv). The easiest way to analyse these data is via the [Analysis tab](https://shiny.dide.ic.ac.uk/DRpower-app/) of the *pfhrp2/3* Planner. Select "Upload a .csv file" and import the data.
