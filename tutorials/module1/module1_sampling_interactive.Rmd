...
TODO: edit message so they are a bit different
```{r quiz-study-pop}
quiz(caption = "QUIZ - Target population",
  question_checkbox("We want to estimate the prevalence of malaria infection in a community of 10,0000 people. Which of the following is the target population?",
           ...
           answer("Only women or only men", correct = FALSE, message = "If we want to estimate the prevalence in the *community* we don't want to focus on a specific demographic or group. <br>"),
           answer("Only children under 5 years old", correct = FALSE, message = "If we want to estimate the prevalence in the *community* we don't want to focus on a specific demographic or group. <br>"),
           answer("Adults over 60 years old", correct = FALSE, message = "If we want to estimate the prevalence in the *community* we don't want to focus on a specific demographic or group. <br>"), 
