...
Try coding it yourself or click on the solution. 
...
So, putting it all together, our estimated prevalence is 0.345 or **34.5%** and our 95%CI is 27.91% to 41.09%.
...
quiz(
  ...
  question("In the context of confidence intervals, what does a 95% confidence level mean?",
    ...
    answer("It means that we are 95% confident that the true population parameter lies within the calculated confidence interval from our sample.", correct = TRUE),
    answer("It means that 95% of the data points lie within the confidence interval.", correct = FALSE),
    answer("It means that there is a 95% probability that the sample estimate falls within the interval.", correct = FALSE),
    ...
    incorrect = "Not quite. Remember, a 95% confidence level refers to our confidence that the interval contains the true population parameter."
  ),
