---
title: 'Activity 7: Designing a study for multiple end-points'
...
Welcome to Activity 7: **Designing a study for multiple end-points**
...
<div style="text-align: left;">
  <a href="scenario0.Rmd" class="custom-button">
    `r fa("circle-check")` Example
  </a>
</div>
